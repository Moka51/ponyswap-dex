...
import { ROUTER_ADDRESS, PANCAKE_ROUTER_ADDRESS } from '../constants'
...
// account is optional
export function getPancakeRouterContract(_: number, library: Web3Provider, account?: string): Contract {

...
import { Card, CardBody, Text } from '@ponyswapdex/uikit'
      ...
      <CardBody>
        ...
        <RowBetween>
          <RowFixed>
            ...
            <QuestionHelper text="For each trade a 0.2% fee is paid. 0.17% goes to liquidity providers and 0.03% goes to the PonySwap treasury." />
          </RowFixed>
          <Text fontSize="14px">

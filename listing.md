...
1. Fork the [PonySwap Dex Frontend](https://github.com/ponyswap/pony-frontend-dex/) repository on GitHub
...
3. Add your **token information** using the example format provided below to `ponyswap.json` in the `/src/constants/token/` directory.
...
"chainId": 56,
"decimals": 18,
"logoURI": "/images/coins/PONY.png"
},
```

If you're not comfortable with GitHub pull requests, please open a [new issue](https://github.com/ponyswap/pony-frontend-dex/issues/new) requesting to be added.
